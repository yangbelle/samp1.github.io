...
function addListener() {
    addHandler(monthUp, "click", monthUpFun);
    addHandler(monthDown, "click", monthDownFun);
    addHandler(yearUp, "click", yearUpFun);
    addHandler(yearDown, "click", yearDownFun);
}
function monthUpFun() {
...
function setCalendar(year, mon, firstWeekDay) {
    ...
    //  addHandler(tableDayVal, "click", fun);
    addHandler(tableDayVal, "click", function (elem) {
